%% Simulation Data        
simu.endTime = 3600;                     % Simulation End Time [s]
simu.solver = 'ode4';                   % simu.solver = 'ode4' for fixed step & simu.solver = 'ode45' for variable step 
simu.dt = 0.1; 	

%% Synchronous Generator

mot.Pr=6e3; % Rated Power
...
mot.lambda_sq_0 = 0;
mot.lambda_sd_0 = mot.lamda_fd;  % (recognizing that the d-axis is always aligned with the rotor magnetic axis                        
mot.J=0.2564; % Inertia Constant kg/m^2
...
%WEC-side converter
wsc.Bdamp = 5e3/(90*pi/30)^2; %damping coeff. Bdamp*angular_speed = Torque, so Bdamp*(max_angular_speed)^2 = 5kW
